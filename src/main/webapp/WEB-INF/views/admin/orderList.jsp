    ...
    <div class="table-responsive col-sm-10">
      <table class="table table-condensed">
        ...
        <tr>
          ...
          <td>${o.orderDate}</td>
          <%
            com.HuXuyang.model.Order o=(com.HuXuyang.model.Order)pageContext.findAttribute("o");
            int userId=o.getCustomerId();
            java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
            com.HuXuyang.dao.UserDao userDao=new com.HuXuyang.dao.UserDao();
          ...
          <td class="cart_total">
            <%
              ...
              String paymentType=com.HuXuyang.model.Payment.findByPaymentId(con,n);
            %>
